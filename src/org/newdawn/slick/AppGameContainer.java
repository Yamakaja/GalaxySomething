...
public class AppGameContainer extends GameContainer {
	 ...
	 * Note: For some (as of yet unknown) reason, resizing was removed from the latter slick builds.
	 * Thus this might need some adaptational work.
	 * @return
	 */
	...
	/**
	 * @see org.newdawn.slick.GameContainer#setMouseCursor(org.newdawn.slick.opengl.TextureData, int, int)
	 */
	public void setMouseCursor(TextureData data, int hotSpotX, int hotSpotY) throws SlickException {
		try {
